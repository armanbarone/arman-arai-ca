...
const heroSlides = [
  { ...hero, alt: "A bride and groom together in warm evening light, her veil catching the sun", position: "center 28%" },
  { ...LANDING_PAGE[3], position: "center 55%" },
  { ...LANDING_PAGE[0], alt: "Black and white portrait of a bride looking toward the light, her veil flowing behind her", position: "center 40%" },
  { ...LANDING_PAGE[1], position: "center 45%" },
  { ...LANDING_PAGE[7], position: "center 50%" },
];
