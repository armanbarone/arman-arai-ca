...
<p><strong>If you want somebody to run the whole thing, that is a reasonable way to buy it.</strong> If you are booking your own officiant and florist, you should not pay a bundled price for a service you are performing yourself. My Whistler collections are the same as everywhere: C$3,000 for six hours, C$4,500 for eight, C$6,000 for ten. The trip up the corridor is quoted on top and agreed before you sign.</p>
...
<p><strong>Core is C$3,000 for six hours, Signature C$4,500 for eight, and Heirloom C$6,000 for ten.</strong> Those are the same figures as a Vancouver city wedding, and the same as a Montréal one, because the photography is the same work. The flight, the nights and the drive up the corridor are quoted separately and agreed before you sign.</p>
...
<p><strong>Core is C$3,000 for six continuous hours, Signature is C$4,500 for eight, and Heirloom is C$6,000 for ten.</strong> Those are the same figures everywhere in Canada. Coming in from Montréal adds the train or the drive and a hotel night, quoted as its own agreed figure and typically C$600 to C$900, so nothing appears at the end.</p>
...
<p><strong>Niagara, Niagara-on-the-Lake and the 1000 Islands cost the same as downtown</strong>, which means a winery Saturday costs exactly what a King Street Saturday costs: C$3,000 for Core, C$4,500 for Signature, C$6,000 for Heirloom. Only the drive differs, and it is quoted before you sign.</p>
...
`,
  ...
  /* ────────────────────────────────────── QUÉBEC CITY & CHARLEVOIX ── */
  {
    ...
    city: "montreal",
    body: `
<p><strong>Québec City and Charlevoix cost exactly what a Montréal wedding costs to photograph: C$3,000 for Core, C$4,500 for Signature, C$6,000 for Heirloom.</strong> The collection price does not move with the city. The three-hour drive and the night are quoted as their own agreed figure before you sign, and have typically run C$200 to C$600.</p>
...
<p>The photography is published and it is the same as everywhere: C$3,000 for Core, C$4,500 for Signature and C$6,000 for Heirloom. What is quoted is the trip, and a Rockies trip has typically run C$1,200 to C$2,000 once the flight, the car and the mountain nights are counted. Send the venue and the date and you get the real figure in the first reply rather than the third.</p>
