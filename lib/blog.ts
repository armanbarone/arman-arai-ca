...
<p><strong>That difference is real and I pass it on</strong>, which is why Core here is C$4,200 and the same collection in Toronto is C$6,450. The gap is the flight, the two hotel nights and the ground transport that a Toronto wedding costs me and a Montréal one does not. Charging the Toronto number for a wedding fifteen minutes from my apartment would be arbitrage.</p>
...
<p>My answer is that the corridor costs the same as the city: <strong>Core is C$8,250 whether the day happens in Kitsilano, in Squamish or in Whistler</strong>, because it is the same trip for me and the flight, the nights and the ground transport are already inside that figure. What does sit outside it is anything that is genuinely somebody else's invoice: a helicopter, a shuttle for guests, a vendor. Those are quoted as their own lines so you can see each one and decline any of them.</p>
...
<p><strong>Core is C$8,250 for eight hours, Signature C$9,950 for ten with a second photographer, and Story Weekend C$12,850 for twelve hours across two days.</strong> Those are the same figures as a Vancouver city wedding, because from Montréal it is the same flight and the same nights. The drive up the corridor is inside them.</p>
...
<p><strong>Vancouver Island carries the same figures as Vancouver: C$8,250 for Core, C$9,950 for Signature and C$12,850 for the two-day Story Weekend.</strong> The ferry, the drive west and the nights are inside them, so there is nothing waiting at the end of the invoice.</p>
...
<p>All three sit at the same price with me: <strong>C$6,850 for Core, C$8,550 for Signature and C$11,300 for Story Weekend</strong>, travel inside the figure. <a href="/contact">Send the date and a rough guest count</a> and I will tell you which of the three actually fits it.</p>
`,
  },
  /* ──────────────────────────────────────────────────────── VANCOUVER ── */
  {
...
<p>Twenty locations, grouped by the problem each one solves, with the light window for each and an honest note on which ones require a permit. All of them are inside the same C$8,250 Core price, whether your day happens in Kitsilano or three hours up the highway.</p>
...
<p>My Vancouver collections are C$8,250 for Core at eight hours, C$9,950 for Signature at ten with a second photographer, and C$12,850 for the two-day Story Weekend. Whistler, Squamish and Vancouver Island carry the same numbers, because they are the same trip for me: the flight, the nights, the ground transport and the ferry are already inside the figure.</p>
...
<p>Prince Edward County sits in the same band as Niagara and Muskoka on my pricing: <strong>C$6,850 for Core at eight hours, C$8,550 for Signature at ten with a second photographer, and C$11,300 for the two-day Story Weekend.</strong> The drive, the nights and the ground transport are already inside those numbers, so nothing arrives at the end of the invoice.</p>
...
<p>Niagara sits with Muskoka and Prince Edward County in the same band: <strong>C$6,850 for Core at eight hours, C$8,550 for Signature at ten with a second photographer, and C$11,300 for the two-day Story Weekend.</strong> Transport and the hotel nights are inside those figures, so there is no travel line at the end of the invoice.</p>
<p>Vertical social clips are in every collection here as everywhere, which matters more for a destination-ish wedding than a hometown one: your guests have driven two hours and want something to post that night, and the gallery is weeks away.</p>
...
<p>Muskoka sits with Niagara and Prince Edward County in one band: <strong>C$6,850 for Core at eight hours, C$8,550 for Signature at ten hours with a second photographer, and C$11,300 for the two-day Story Weekend.</strong> The drive, the accommodation and the ground transport are inside those numbers.</p>
...
<p>For a genuine winter landscape, <strong>the Laurentians</strong> are ninety minutes north and reliably snow-covered when the city is slush. That moves you into the Laurentians and Townships pricing at C$5,150 for Core, and it wants a chalet with a fire rather than a day trip.</p>
...
<p>My own pricing does not change by season, because my costs do not: Core in Montréal is C$4,200 in January exactly as it is in June. What changes is that in January you can probably have the date you want.</p>
...
<p><strong>Toronto and the GTA: Core is C$6,450 for eight continuous hours, Signature is C$8,150 for ten hours with a second photographer for six of them, and Story Weekend is C$10,850 for twelve hours across two days.</strong> Those are whole numbers with my travel from Montréal already inside them, so nothing appears at the end.</p>
...
<p><strong>Vertical social clips are in every collection rather than sold as an add-on.</strong> This matters disproportionately for a multi-day wedding, because the gap between the last event and the gallery is exactly when several hundred people are asking to see something and the answer is otherwise nothing.</p>
